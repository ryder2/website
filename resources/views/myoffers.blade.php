        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" method="POST" action="{!! url('/viewofferapplication', ['id'=>$offre->id]) !!}">
                    ...
                    @else
                    <br><br><button id="seeacceptedoffer" name="seeacceptedoffer" type="button" class="btn btn-success accepted">You already accepted an offer. See accepted offer</button>
                    @endif
...
@else
<div class="col-md-8 col-md-offset-2">
    <div class="alert alert-warning"><center><b>You can't acces this section as a mechanic</b></center></div>
</div>
@endif
@endsection